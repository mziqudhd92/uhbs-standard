#!/usr/bin/env python3
"""Calculate UHQS 4.4.5 from report.json or explicit module scores."""
...
def main() -> int:
    ...
    p = argparse.ArgumentParser(description="UHQS 4.4.5 composite score")
    ...
    echo_ok(
        f"UHQS 4.4.5 = {uhqs.uhqs}  grade={uhqs.grade}  δ_C={uhqs.delta_c}  "
