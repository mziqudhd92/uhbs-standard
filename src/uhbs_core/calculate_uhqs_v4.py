#!/usr/bin/env python3
"""Calculate UHQS 4.0.1 from report.json or explicit module scores."""
...
def main() -> int:
    p = argparse.ArgumentParser(description="UHQS 4.0.1 composite score")
    ...
    print(
        f"UHQS 4.0.1 = {uhqs.uhqs}  grade={uhqs.grade}  δ_C={uhqs.delta_c}  "
