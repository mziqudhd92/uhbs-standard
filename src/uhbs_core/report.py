"""UHBS v4.2.1 scorecard + JSON report writer."""
...
def render_card(
    ...
    lines += [
        ...
        f"FINAL COMPOSITE SCORE (UHQS 4.2.1)      : {uhqs.uhqs} / 100",
...
def write_report(
    ...
    payload = {
        "framework": "Universal Honeypot Benchmarking Standard (UHBS) v4.2.1",
