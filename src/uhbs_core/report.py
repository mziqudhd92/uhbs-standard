"""UHBS v4.4.1 scorecard + JSON report writer."""
...
def render_card(
    ...
    lines = [
        "====================================================================================",
        "                  UNIVERSAL HONEYPOT BENCHMARK SCORECARD v4.4.1",
        "====================================================================================",
    ...
    lines += [
        ...
        f"FINAL COMPOSITE SCORE (UHQS 4.4.1)      : {uhqs.uhqs} / 100",
...
def write_report(
    ...
    payload = {
        "framework": "Universal Honeypot Benchmarking Standard (UHBS) v4.4.1",
