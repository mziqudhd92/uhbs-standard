    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center pt-24 pb-16 overflow-hidden">
      ...
      >
        ...
        <motion.h1 variants={fadeUpVariant} className="text-5xl md:text-7xl font-bold leading-tight mb-6 max-w-4xl text-foreground font-sans tracking-tight">
          ...
          <span className="text-muted-foreground font-mono text-4xl md:text-6xl tracking-tighter">(UHBS) v4.4.1 <span className="text-primary/70">· 2026</span></span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <motion.div variants={fadeUpVariant}>
            ...
            <div className="prose prose-invert prose-lg text-secondary-foreground font-light leading-relaxed">
              <p>
                The UHBS v4.4.1 framework provides a rigorous technical foundation for evaluating the efficacy, safety, and realism of deception assets prior to deployment.
              </p>
              <p className="mt-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-secondary-foreground text-sm">
                    UHBS v4.4.1 is an open-source beta-status framework for comparing and grading honeypots by class and protocol — mathematically reproducible, not a consortium or adopted industry standard.
                  </p>
                </div>
              </div>
            </div>
  ...
  const differences = [
    {
      ...
      right: { label: "UHBS v4.4.1", text: "Employs a Dual-Plane Audit Philosophy — requires pre-deployment static code analysis (Module F) to catch hardcoded SSH keys, static seeds, or vulnerable command wrappers before dynamic sandbox probing begins." },
    },
    {
      num: "02",
      ...
      right: { label: "UHBS v4.4.1", text: "Implements a strict Safety Gate Multiplier (δ_C). If Module D containment drops below 95/100, an exponential penalty degrades the entire UHQS score regardless of performance elsewhere." },
    },
    {
      num: "03",
      ...
      right: { label: "UHBS v4.4.1", text: "Target Profile Specification (profile.yaml) adjusts evaluation weights. ICS-SCADA weights protocol fidelity at w_A = 0.35, while POSIX shells emphasize state behavior at w_B = 0.25." },
    },
    {
      num: "04",
      ...
      right: { label: "UHBS v4.4.1", text: "Explicitly tests next-generation decoys: indirect prompt injections, system prompt leaks, context exhaustion attacks, and cloud API boundary breaches across public-cloud control planes and container orchestration surfaces." },
    },
  ];
      ...
      >
        ...
        <motion.div variants={fadeUpVariant} className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold font-sans mb-4 flex items-center gap-3">
            ...
            UHBS v4.4.1 vs. 5-Dimension Framework
          </h2>
          <p className="text-secondary-foreground max-w-3xl">
            Proposed five-dimension honeypot metrics (interaction, data quality, resource efficiency, stealth, fingerprinting resistance) are a useful conceptual lens—not an adopted industry standard. UHBS v4.4.1 operationalizes overlapping axes with dual-plane auditing, a non-linear Safety Gate, and coverage for modern decoy classes. For the full evidence-graded comparison against fourteen framework/model families, see the{" "}
          ...
          <table className="w-full text-left text-sm font-mono border-collapse">
            <thead>
              <tr className="border-b border-border text-muted-foreground">
                ...
                <th className="py-3 pr-6 font-normal w-1/5">UHBS v4.4.1 Module</th>
                <th className="py-3 font-normal">Key Expansion in UHBS v4.4.1</th>
              </tr>
            </thead>
        ...
        <motion.div variants={fadeUpVariant} className="border border-primary/30 bg-primary/5 p-6 flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-secondary-foreground leading-relaxed">
              Five-dimension proposals provide a useful conceptual lens for categorizing honeypot quality. UHBS v4.4.1 turns overlapping concerns into a machine-verifiable evaluation — adding a pre-deployment code audit plane (Module F), a non-linear safety gate that makes containment failures non-maskable, and explicit support for GenAI and OT/ICS decoy classes. See the{" "}
              <a href="mkdocs/mappings/related-frameworks/" className="text-primary hover:underline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <motion.div variants={fadeUpVariant} className="lg:col-span-7 bg-card border border-border p-4 md:p-6">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4 px-2">
              <h3 className="font-mono text-primary text-sm uppercase tracking-wider">The UHQS 4.4.1 Formula</h3>
    ...
    <footer className="py-12 border-t border-border bg-background">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="font-mono text-sm text-secondary-foreground mb-4">
          Universal Honeypot Benchmarking Standard <span className="text-primary/70">·</span> v4.4.1 <span className="text-primary/70">·</span> 2026
        </div>
