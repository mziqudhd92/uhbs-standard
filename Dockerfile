...
# Build:  docker build -t uhbs:4.3.5 .
# Run:    docker run --rm -v "$PWD:/work" -w /work uhbs:4.3.5 validate-scorecard ./scorecard.json
#
...
LABEL org.opencontainers.image.version="4.3.5"
