...
**Target id:** `beelzebub-http` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **52.77** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **66.02** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
| Module E: Scalability & Latency | 100.0 | 0.15 | PASSED | service alive after load (connect 0.9ms) |
...
Module E: Scalability & Latency     : 100.0/100       0.15     PASSED (service alive after load (connect 0.9ms))
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 66.02 / 100
...
This page is the protocol-level proof hub for **beelzebub** on **http**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/beelzebub-http.md`](../../../../scorecards/beelzebub-http.md)
