...
**Target id:** `beelzebub-telnet` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **39.16** | F | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **47.89** | F | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 47.89 / 100
...
This page is the protocol-level proof hub for **beelzebub** on **telnet**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/beelzebub-telnet.md`](../../../../scorecards/beelzebub-telnet.md)
