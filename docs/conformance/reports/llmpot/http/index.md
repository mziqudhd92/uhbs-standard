...
**Target id:** `llmpot-http` · **Evaluated:** 2026-07-28

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **45.84** | F | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **63.11** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |

## Full run — module breakdown (analyst view)

| Module | Score | Weight | Status | Notes |
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 86.4 | 0.25 | PASSED | median=0.068ms pstdev=2.085ms (target jitter often <2ms vs native) |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  86.4/100       0.25     PASSED (median=0.068ms pstdev=2.085ms (target jitter often <2ms vs native))
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 63.11 / 100
...
This page is the protocol-level proof hub for **llmpot** on **http**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
