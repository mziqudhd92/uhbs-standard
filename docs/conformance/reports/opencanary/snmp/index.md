...
**UHBS:** v4.2.2 · **Class:** Low-Interaction · **Protocol:** `snmp`  
**Target id:** `opencanary-snmp` · **Evaluated:** 2026-07-27
...
| Module E: Scalability & Latency | 35.0 | 0.10 | PARTIAL | P50=1505.2ms P95=1511.9ms P99=1515.6ms TPS_limit=150.0ms proto=snmp |
...
Module E: Scalability & Latency     :  35.0/100       0.10     PARTIAL (P50=1505.2ms P95=1511.9ms P99=1515.6ms TPS_limit=150.0ms proto=snmp)
...
This page is the protocol-level proof hub for **opencanary** on **snmp**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.

### Module interpretation (this protocol)

| Module | Score | Analyst reading |
| --- | ---: | --- |
| A — Protocol Fidelity | 59.7 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
...
- Published scorecard page: [`../../../../scorecards/opencanary-snmp.md`](../../../../scorecards/opencanary-snmp.md)
