...
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **50.81** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **61.99** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 61.99 / 100
...
This page is the protocol-level proof hub for **opencanary** on **vnc**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/opencanary-vnc.md`](../../../../scorecards/opencanary-vnc.md)
