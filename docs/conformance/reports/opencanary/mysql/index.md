...
**Target id:** `opencanary-mysql` · **Evaluated:** 2026-07-27
...
This page is the protocol-level proof hub for **opencanary** on **mysql**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/opencanary-mysql.md`](../../../../scorecards/opencanary-mysql.md)
