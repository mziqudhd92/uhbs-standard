...
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **52.34** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
...
This page is the protocol-level proof hub for **opencanary** on **http**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/opencanary-web-api.md`](../../../../scorecards/opencanary-web-api.md)
