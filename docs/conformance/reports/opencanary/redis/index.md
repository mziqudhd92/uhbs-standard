...
**UHBS:** v4.2.2 · **Class:** Low-Interaction · **Protocol:** `redis`  
**Target id:** `opencanary-redis` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **45.07** | F | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **53.72** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |

## Full run — module breakdown (analyst view)

| Module | Score | Weight | Status | Notes |
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 70.0 | 0.30 | PASSED | — |
| Module B: Behavioral Realism | 50.5 | 0.15 | PARTIAL | — |
...
====================================================================================
Target System         : opencanary-redis
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  70.0/100       0.30     PASSED (-NOAUTH Authentication required.
)
Module B: Behavioral Realism        :  50.5/100       0.15     PARTIAL (-NOAUTH Authentication required.
)
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 53.72 / 100
...
This page is the protocol-level proof hub for **opencanary** on **redis**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.

### Module interpretation (this protocol)

| Module | Score | Analyst reading |
| --- | ---: | --- |
| A — Protocol Fidelity | 70.0 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
| B — Behavioral Realism | 50.5 | Post-connect realism (auth/session). Low often means credential-only or reject-by-design. **CTI:** treat primarily as auth/connection intelligence. |
...
- Published scorecard page: [`../../../../scorecards/opencanary-redis.md`](../../../../scorecards/opencanary-redis.md)
