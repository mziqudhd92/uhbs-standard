...
**Target id:** `opencanary-ftp` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **50.47** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **61.5** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 61.5 / 100
...
This page is the protocol-level proof hub for **opencanary** on **ftp**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/opencanary-ftp.md`](../../../../scorecards/opencanary-ftp.md)
