...
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **40.01** | F | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **46.44** | F | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
| Module E: Scalability & Latency | 35.0 | 0.10 | PARTIAL | P50=1506.6ms P95=1511.6ms P99=1514.7ms TPS_limit=150.0ms proto=sip |
...
Module E: Scalability & Latency     :  35.0/100       0.10     PARTIAL (P50=1506.6ms P95=1511.6ms P99=1514.7ms TPS_limit=150.0ms proto=sip)
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 46.44 / 100
...
This page is the protocol-level proof hub for **opencanary** on **sip**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
| B — Behavioral Realism | 62.5 | Post-connect realism (auth/session). Low often means credential-only or reject-by-design. **CTI:** treat primarily as auth/connection intelligence. |
...
- Published scorecard page: [`../../../../scorecards/opencanary-sip.md`](../../../../scorecards/opencanary-sip.md)
