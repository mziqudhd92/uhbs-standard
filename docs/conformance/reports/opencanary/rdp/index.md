...
**UHBS:** v4.2.2 · **Class:** Low-Interaction · **Protocol:** `rdp`  
**Target id:** `opencanary-rdp` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **50.13** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **61.01** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |

## Full run — module breakdown (analyst view)

| Module | Score | Weight | Status | Notes |
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 88.0 | 0.30 | PASSED | fsm=70 nego=100 timing=100 |
| Module B: Behavioral Realism | 74.5 | 0.15 | PASSED | survived binary blast |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  88.0/100       0.30     PASSED (fsm=70 nego=100 timing=100)
Module B: Behavioral Realism        :  74.5/100       0.15     PASSED (survived binary blast)
...
This page is the protocol-level proof hub for **opencanary** on **rdp**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
| B — Behavioral Realism | 74.5 | Post-connect realism (auth/session). Low often means credential-only or reject-by-design. **CTI:** treat primarily as auth/connection intelligence. |
...
- Published scorecard page: [`../../../../scorecards/opencanary-rdp.md`](../../../../scorecards/opencanary-rdp.md)
