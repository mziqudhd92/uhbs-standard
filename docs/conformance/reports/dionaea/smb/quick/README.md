...
**UHQS 48.25 / F** · UHBS v4.2.2 · δ_C=0.5625
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 70.4 | 0.30 | PASSED | median=0.586ms pstdev=144.746ms (target jitter often <2ms vs native) |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  70.4/100       0.30     PASSED (median=0.586ms pstdev=144.746ms (target jitter often <2ms vs native))
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 48.25 / 100
