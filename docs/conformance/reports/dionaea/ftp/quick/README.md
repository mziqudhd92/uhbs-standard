...
**UHQS 50.95 / D** · UHBS v4.2.2 · δ_C=0.5625
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 86.4 | 0.30 | PASSED | median=0.308ms pstdev=200.082ms (target jitter often <2ms vs native) |
...
| Module F: Static Code Audit | 86.3 | 0.20 | PASSED | sleep/blocking markers in non-test code≈1 |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  86.4/100       0.30     PASSED (median=0.308ms pstdev=200.082ms (target jitter often <2ms vs native))
...
Module F: Static Code Audit         :  86.3/100       0.20     PASSED (sleep/blocking markers in non-test code≈1)
------------------------------------------------------------------------------------
SAFETY GATE MULTIPLIER                : δ_C = 0.5625 (C = 75.0 < 95 — exponential penalty)
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 50.95 / 100
