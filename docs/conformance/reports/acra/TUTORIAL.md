...
**Not graded** — Acra is a database encryption/SQL proxy suite with poison-record IDS, not a standalone protocol honeypot listener. No UHBS protocol grade applies.
