# qeeqbox-honeypots — MYSQL

**Status:** Informative · evaluation proof  
**UHBS:** v4.2.2 · **Class:** Database · **Protocol:** `mysql`  
**Target id:** `qeeqbox-mysql` · **Evaluated:** 2026-07-29
...
This page is the protocol-level proof hub for **qeeqbox-honeypots** on **mysql**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/qeeqbox-mysql.md`](../../../../scorecards/qeeqbox-mysql.md)
