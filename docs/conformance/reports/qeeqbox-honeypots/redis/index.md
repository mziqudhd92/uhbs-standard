# qeeqbox-honeypots — REDIS

**Status:** Informative · evaluation proof  
**UHBS:** v4.2.2 · **Class:** Low-Interaction · **Protocol:** `redis`  
**Target id:** `qeeqbox-redis` · **Evaluated:** 2026-07-29

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **34.61** | F | 0.5625 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **34.5** | F | 0.5625 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |

## Full run — module breakdown (analyst view)

| Module | Score | Weight | Status | Notes |
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 54.0 | 0.30 | PARTIAL | connection closed on invalid verb (no RESP error emitted) |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  54.0/100       0.30     PARTIAL (connection closed on invalid verb (no RESP error emitted))
...
FINAL COMPOSITE SCORE (UHQS 4.2.2)      : 34.5 / 100
...
This page is the protocol-level proof hub for **qeeqbox-honeypots** on **redis**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.

### Module interpretation (this protocol)

| Module | Score | Analyst reading |
| --- | ---: | --- |
| A — Protocol Fidelity | 54.0 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
...
- Published scorecard page: [`../../../../scorecards/qeeqbox-redis.md`](../../../../scorecards/qeeqbox-redis.md)
