...
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **29.88** | F | 0.5625 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **29.77** | F | 0.5625 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
This page is the protocol-level proof hub for **qeeqbox-honeypots** on **telnet**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
