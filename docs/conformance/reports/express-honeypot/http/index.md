...
**Target id:** `express-honeypot-http` · **Evaluated:** 2026-07-29
...
This page is the protocol-level proof hub for **express-honeypot** on **http**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/express-honeypot-http.md`](../../../../scorecards/express-honeypot-http.md)
