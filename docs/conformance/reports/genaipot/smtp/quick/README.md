# genaipot / smtp — Quick artifacts

**UHQS 30.9 / F** · UHBS v4.2.2 · δ_C=0.5625

## Module scores

| Module | Score | Weight | Status | Notes |
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 30.0 | 0.30 | PARTIAL | codes=[220, 500, 500] (want 503) |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  30.0/100       0.30     PARTIAL (codes=[220, 500, 500] (want 503))
...
FINAL COMPOSITE SCORE (UHQS 4.2.2)      : 30.9 / 100
