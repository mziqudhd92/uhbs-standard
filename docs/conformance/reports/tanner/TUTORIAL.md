# Tutorial: tanner (not graded standalone)

**Upstream:** [mushorg/tanner](https://github.com/mushorg/tanner)

Pair with SNARE for HTTP decoy grading. Standalone TANNER API/UI is not equivalent to an HTTP honeypot surface.

See also [snare TUTORIAL](../snare/TUTORIAL.md).
...
UHBS 4.2.2 evaluation notes are informative only — not certifications or endorsements. Product names appear only under conformance as survey/evaluation evidence.
