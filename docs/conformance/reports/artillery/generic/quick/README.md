# artillery / generic — quick artifacts

**UHQS 39.84 / F** · UHBS v4.2.2 · δ_C=0.5625
...
| Module E: Scalability & Latency | 100.0 | 0.10 | PASSED | service alive after load (connect 1.7ms) |
...
Module E: Scalability & Latency     : 100.0/100       0.10     PASSED (service alive after load (connect 1.7ms))
