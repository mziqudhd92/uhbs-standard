# trapster / telnet — quick artifacts

**UHQS 52.49 / D** · UHBS v4.2.2 · δ_C=0.5625
...
| Module E: Scalability & Latency | 100.0 | 0.10 | PASSED | service alive after load (connect 1.5ms) |
...
Module E: Scalability & Latency     : 100.0/100       0.10     PASSED (service alive after load (connect 1.5ms))
Module F: Static Code Audit         :  79.7/100       0.20     PASSED (1 predictable PRNG seeds: trapster/modules/http.py)
------------------------------------------------------------------------------------
SAFETY GATE MULTIPLIER                : δ_C = 0.5625 (C = 75.0 < 95 — exponential penalty)
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 52.49 / 100
