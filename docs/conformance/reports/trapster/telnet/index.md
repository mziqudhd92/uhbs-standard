...
**UHBS:** v4.2.2 · **Class:** Low-Interaction · **Protocol:** `telnet`  
**Target id:** `trapster-telnet` · **Evaluated:** 2026-07-27

| Run | UHQS | Grade | δ_C | Artifacts |
| --- | ---: | --- | --- | --- |
| [Quick](quick/README.md) | **52.49** | D | 0.81 | [`SCORECARD.txt`](quick/SCORECARD.txt) · [`report.json`](quick/report.json) |
| [Full](full/README.md) | **64.9** | D | 0.81 | [`SCORECARD.txt`](full/SCORECARD.txt) · [`report.json`](full/report.json) |
...
| Module E: Scalability & Latency | 100.0 | 0.10 | PASSED | service alive after load (connect 1.6ms) |
...
Module E: Scalability & Latency     : 100.0/100       0.10     PASSED (service alive after load (connect 1.6ms))
...
This page is the protocol-level proof hub for **trapster** on **telnet**. Prefer the **full** run over quick for operational decisions. Numbers without the verbatim SCORECARD (or `report.json`) are not trustworthy citations.
...
- Published scorecard page: [`../../../../scorecards/trapster-telnet.md`](../../../../scorecards/trapster-telnet.md)
