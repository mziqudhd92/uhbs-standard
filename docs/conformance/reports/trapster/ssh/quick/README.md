# trapster / ssh — quick artifacts

**UHQS 40.06 / F** · UHBS v4.2.2 · δ_C=1.0
...
| Module C: Telemetry Quality | 0.0 | 0.25 | FAILED | accepted |
| Module D: Safety & Containment (C) | 96.0 | GATE | PASSED | leak/unstable |
...
Module C: Telemetry Quality         :   0.0/100       0.25     FAILED (accepted)
Module D: Safety & Containment (C)  :  96.0/100       GATE     PASSED (leak/unstable)
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 40.06 / 100
