# Scorecard: qeeqbox-honeypots — vnc

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `vnc`  
**Target id (lab):** `qeeqbox-vnc` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 32.92 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **32.81** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [qeeqbox-honeypots / vnc](../conformance/reports/qeeqbox-honeypots/vnc/index.md) · [Tutorial](../conformance/reports/qeeqbox-honeypots/TUTORIAL.md) · [Methodology](../conformance/reports/qeeqbox-honeypots/METHODOLOGY.md)  
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 46.0 | 0.30 | PARTIAL | no banner |
| Module B: Behavioral Realism | 46.5 | 0.15 | PARTIAL | no banner |
...
| --- | ---: | --- |
| A — Protocol Fidelity | 46.0 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
| B — Behavioral Realism | 46.5 | Post-connect realism (auth/session). Low often means credential-only or reject-by-design. |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  46.0/100       0.30     PARTIAL (no banner)
Module B: Behavioral Realism        :  46.5/100       0.15     PARTIAL (no banner)
...
FINAL COMPOSITE SCORE (UHQS 4.2.2)      : 32.81 / 100
