# Scorecard: wordpot — http

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `http`  
**Target id (lab):** `wordpot-http` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 41.71 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **41.6** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [wordpot / http](../conformance/reports/wordpot/http/index.md) · [Tutorial](../conformance/reports/wordpot/TUTORIAL.md) · [Methodology](../conformance/reports/wordpot/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/wordpot/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/wordpot/METHODOLOGY.md).
