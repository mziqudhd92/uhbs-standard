...
**Full UHQS:** **41.6** · Grade **F** · δ_C **0.5625**  
**Quick UHQS:** 41.71 / F  
**Evaluated:** 2026-07-29 · **UHBS:** 4.2.2

Source report: [`../conformance/reports/wordpot/http/`](../conformance/reports/wordpot/http/index.md)
...
See the report [tutorial](../conformance/reports/wordpot/TUTORIAL.md) and [methodology](../conformance/reports/wordpot/METHODOLOGY.md).
