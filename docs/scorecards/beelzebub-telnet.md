# Scorecard: beelzebub — telnet

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `telnet`  
**Target id (lab):** `beelzebub-telnet` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 39.16 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **47.89** | **F** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [beelzebub / telnet](../conformance/reports/beelzebub/telnet/index.md) · [Tutorial](../conformance/reports/beelzebub/TUTORIAL.md) · [Methodology](../conformance/reports/beelzebub/METHODOLOGY.md)  
