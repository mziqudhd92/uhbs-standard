# Scorecard: trapster — ftp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `ftp`  
**Target id (lab):** `trapster-ftp` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 43.37 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **51.78** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [trapster / ftp](../conformance/reports/trapster/ftp/index.md) · [Tutorial](../conformance/reports/trapster/TUTORIAL.md) · [Methodology](../conformance/reports/trapster/METHODOLOGY.md)  
