# Scorecard: datatrap — http

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `http`  
**Target id (lab):** `datatrap-http` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 45.84 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **65.85** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / http](../conformance/reports/datatrap/http/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 65.85 / 100
