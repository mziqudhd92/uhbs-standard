# Scorecard: datatrap — postgres

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `postgres`  
**Target id (lab):** `datatrap-postgres` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 40.35 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **57.94** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / postgres](../conformance/reports/datatrap/postgres/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
...
| Module B: Behavioral Realism | 42.5 | 0.15 | PARTIAL | AuthenticationOk (accepted bad password) |
...
====================================================================================
Target System         : datatrap-postgres
...
Module B: Behavioral Realism        :  42.5/100       0.15     PARTIAL (AuthenticationOk (accepted bad password))
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 57.94 / 100
