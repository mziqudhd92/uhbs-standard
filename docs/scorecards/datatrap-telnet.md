# Scorecard: datatrap — telnet

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `telnet`  
**Target id (lab):** `datatrap-telnet` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 43.38 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **59.88** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / telnet](../conformance/reports/datatrap/telnet/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 59.88 / 100
