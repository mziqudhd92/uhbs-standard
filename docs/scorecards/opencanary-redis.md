# Scorecard: opencanary — redis

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `redis`  
**Target id (lab):** `opencanary-redis` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 45.07 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **53.72** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [opencanary / redis](../conformance/reports/opencanary/redis/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
