# Scorecard: opencanary — snmp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `snmp`  
**Target id (lab):** `opencanary-snmp` · **Evaluation date:** 2026-07-27
...
**Report hub:** [opencanary / snmp](../conformance/reports/opencanary/snmp/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
