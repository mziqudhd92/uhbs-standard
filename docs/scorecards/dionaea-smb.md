# Scorecard: dionaea — smb

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `smb`  
**Target id (lab):** `dionaea-smb` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 48.25 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **54.07** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [dionaea / smb](../conformance/reports/dionaea/smb/index.md) · [Tutorial](../conformance/reports/dionaea/TUTORIAL.md) · [Methodology](../conformance/reports/dionaea/METHODOLOGY.md)  
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 70.4 | 0.30 | PASSED | median=0.369ms pstdev=199.424ms (target jitter often <2ms vs native) |
...
| Module E: Scalability & Latency | 55.0 | 0.10 | PARTIAL | P50=1025.6ms P95=1183.5ms P99=1203.6ms TPS_limit=150.0ms proto=smb |
...
| --- | ---: | --- |
| A — Protocol Fidelity | 70.4 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  70.4/100       0.30     PASSED (median=0.369ms pstdev=199.424ms (target jitter often <2ms vs native))
...
Module E: Scalability & Latency     :  55.0/100       0.10     PARTIAL (P50=1025.6ms P95=1183.5ms P99=1203.6ms TPS_limit=150.0ms proto=smb)
...
Re-run commands are in the [tutorial](../conformance/reports/dionaea/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/dionaea/METHODOLOGY.md).
