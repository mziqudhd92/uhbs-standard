# Scorecard: ssh-auth-logger — ssh

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `ssh`  
**Target id (lab):** `ssh-auth-logger-ssh` · **Evaluation date:** 2026-07-29
...
**Report hub:** [ssh-auth-logger / ssh](../conformance/reports/ssh-auth-logger/ssh/index.md) · [Tutorial](../conformance/reports/ssh-auth-logger/TUTORIAL.md) · [Methodology](../conformance/reports/ssh-auth-logger/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/ssh-auth-logger/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/ssh-auth-logger/METHODOLOGY.md).
