...
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `pop3`  
**Target id (lab):** `genaipot-pop3` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 44.24 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **44.13** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [genaipot / pop3](../conformance/reports/genaipot/pop3/index.md) · [Tutorial](../conformance/reports/genaipot/TUTORIAL.md) · [Methodology](../conformance/reports/genaipot/METHODOLOGY.md)  
...
| --- | ---: | --- |
| A — Protocol Fidelity | 95.1 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
...
Re-run commands are in the [tutorial](../conformance/reports/genaipot/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/genaipot/METHODOLOGY.md).
