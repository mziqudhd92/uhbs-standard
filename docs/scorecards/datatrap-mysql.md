# Scorecard: datatrap — mysql

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `mysql`  
**Target id (lab):** `datatrap-mysql` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 40.35 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **50.65** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / mysql](../conformance/reports/datatrap/mysql/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
