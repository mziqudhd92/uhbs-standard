# Scorecard: qeeqbox-honeypots — smtp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `smtp`  
**Target id (lab):** `qeeqbox-smtp` · **Evaluation date:** 2026-07-29
...
**Report hub:** [qeeqbox-honeypots / smtp](../conformance/reports/qeeqbox-honeypots/smtp/index.md) · [Tutorial](../conformance/reports/qeeqbox-honeypots/TUTORIAL.md) · [Methodology](../conformance/reports/qeeqbox-honeypots/METHODOLOGY.md)  
