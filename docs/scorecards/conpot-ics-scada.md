# Scorecard: conpot — lab

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** ICS-SCADA · **Protocol / surface:** `lab`  
**Target id (lab):** `conpot` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 44.55 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **55.4** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [conpot / lab](../conformance/reports/conpot/index.md) · [Tutorial](../conformance/reports/conpot/TUTORIAL.md) · [Methodology](../conformance/reports/conpot/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/conpot/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/conpot/METHODOLOGY.md).
