# Scorecard: opencanary — smb

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `smb`  
**Target id (lab):** `Low-Interaction-SMB` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 50.13 | D | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **57.72** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [opencanary / smb](../conformance/reports/opencanary/smb/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 70.4 | 0.30 | PASSED | median=0.302ms pstdev=72.676ms (target jitter often <2ms vs native) |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  70.4/100       0.30     PASSED (median=0.302ms pstdev=72.676ms (target jitter often <2ms vs native))
...
FINAL COMPOSITE SCORE (UHQS 4.0.1)      : 57.72 / 100
