# Scorecard: honeyhttpd — http

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `http`  
**Target id (lab):** `honeyhttpd-http` · **Evaluation date:** 2026-07-29
...
**Report hub:** [honeyhttpd / http](../conformance/reports/honeyhttpd/http/index.md) · [Tutorial](../conformance/reports/honeyhttpd/TUTORIAL.md) · [Methodology](../conformance/reports/honeyhttpd/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/honeyhttpd/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/honeyhttpd/METHODOLOGY.md).
