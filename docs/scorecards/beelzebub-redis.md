# Scorecard: beelzebub — redis

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `redis`  
**Target id (lab):** `beelzebub-redis` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 50.56 | D | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **61.01** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [beelzebub / redis](../conformance/reports/beelzebub/redis/index.md) · [Tutorial](../conformance/reports/beelzebub/TUTORIAL.md) · [Methodology](../conformance/reports/beelzebub/METHODOLOGY.md)  
