# Scorecard: modpot — http

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `http`  
**Target id (lab):** `modpot-http` · **Evaluation date:** 2026-07-29
...
**Report hub:** [../conformance/reports/modpot/http/index.md](../conformance/reports/modpot/http/index.md)
...
See [tutorial](../conformance/reports/modpot/TUTORIAL.md) and [methodology](../conformance/reports/modpot/METHODOLOGY.md).
