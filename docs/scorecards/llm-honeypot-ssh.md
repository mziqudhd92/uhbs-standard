# Scorecard: llm-honeypot — ssh

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `ssh`  
**Target id (lab):** `llm-honeypot-ssh` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 67.94 | D | 1.0 | See report hub quick artifacts |
| **Full (authoritative)** | **61.17** | **D** | **1.0** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [llm-honeypot / ssh](../conformance/reports/llm-honeypot/ssh/index.md) · [Tutorial](../conformance/reports/llm-honeypot/TUTORIAL.md) · [Methodology](../conformance/reports/llm-honeypot/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/llm-honeypot/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/llm-honeypot/METHODOLOGY.md).
