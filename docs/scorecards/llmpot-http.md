# Scorecard: llmpot — http

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `http`  
**Target id (lab):** `llmpot-http` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 45.84 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **63.11** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [llmpot / http](../conformance/reports/llmpot/http/index.md) · [Tutorial](../conformance/reports/llmpot/TUTORIAL.md) · [Methodology](../conformance/reports/llmpot/METHODOLOGY.md)  
