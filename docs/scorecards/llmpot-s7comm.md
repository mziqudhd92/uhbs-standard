# Scorecard: llmpot — s7comm

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** ICS-SCADA · **Protocol / surface:** `s7comm`  
**Target id (lab):** `llmpot-s7comm` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 45.53 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **65.41** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [llmpot / s7comm](../conformance/reports/llmpot/s7comm/index.md) · [Tutorial](../conformance/reports/llmpot/TUTORIAL.md) · [Methodology](../conformance/reports/llmpot/METHODOLOGY.md)  
