# Scorecard: opencanary — tftp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `tftp`  
**Target id (lab):** `opencanary-tftp` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 40.69 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **47.42** | **F** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [opencanary / tftp](../conformance/reports/opencanary/tftp/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
...
| Module E: Scalability & Latency | 35.0 | 0.10 | PARTIAL | P50=1508.6ms P95=1514.6ms P99=1517.1ms TPS_limit=150.0ms proto=tftp |
...
| B — Behavioral Realism | 70.5 | Post-connect realism (auth/session). Low often means credential-only or reject-by-design. |
...
Module E: Scalability & Latency     :  35.0/100       0.10     PARTIAL (P50=1508.6ms P95=1514.6ms P99=1517.1ms TPS_limit=150.0ms proto=tftp)
