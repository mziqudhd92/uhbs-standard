...
| --- | ---: | ---: | --- |
| Module A: Protocol Fidelity | 56.5/100 | 0.30 | PARTIAL (generic TCP) |
...
| Module E: Scalability & Latency | 100.0/100 | 0.10 | PASSED (P95: 7.2 ms) |
...
| **Final Composite Score (UHQS 4.0)** | **51.90 / 100** |
...
- Quick scorecard: [`../conformance/reports/endlessh/quick/SCORECARD.txt`](../conformance/reports/endlessh/quick/SCORECARD.txt) (UHQS **42.75** / F)
