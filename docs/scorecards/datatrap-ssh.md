# Scorecard: datatrap — ssh

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `ssh`  
**Target id (lab):** `datatrap-ssh` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 59.88 | D | 1.0 | See report hub quick artifacts |
| **Full (authoritative)** | **55.61** | **D** | **1.0** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / ssh](../conformance/reports/datatrap/ssh/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 55.61 / 100
