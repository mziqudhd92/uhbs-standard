...
**Target id (lab):** `node-ftp-honeypot` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 35.96 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **35.85** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [node-ftp-honeypot / ftp](../conformance/reports/node-ftp-honeypot/ftp/index.md) · [Tutorial](../conformance/reports/node-ftp-honeypot/TUTORIAL.md) · [Methodology](../conformance/reports/node-ftp-honeypot/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/node-ftp-honeypot/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/node-ftp-honeypot/METHODOLOGY.md).
