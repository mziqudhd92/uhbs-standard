# Scorecard: datatrap — redis

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `redis`  
**Target id (lab):** `datatrap-redis` · **Evaluation date:** 2026-07-28

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 42.37 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **60.85** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [datatrap / redis](../conformance/reports/datatrap/redis/index.md) · [Tutorial](../conformance/reports/datatrap/TUTORIAL.md) · [Methodology](../conformance/reports/datatrap/METHODOLOGY.md)  
...
| --- | ---: | --- | --- | --- |
| Module A: Protocol Fidelity | 84.0 | 0.30 | PASSED | connection closed on invalid verb (no RESP error emitted) |
...
| --- | ---: | --- |
| A — Protocol Fidelity | 84.0 | Protocol speak / banner-handshake quality for keeping automated clients engaged. |
...
------------------------------------------------------------------------------------
Module A: Protocol Fidelity         :  84.0/100       0.30     PASSED (connection closed on invalid verb (no RESP error emitted))
...
FINAL COMPOSITE SCORE (UHQS 4.2.1)      : 60.85 / 100
...
Re-run commands are in the [tutorial](../conformance/reports/datatrap/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/datatrap/METHODOLOGY.md).
