# Scorecard: opencanary — ntp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `ntp`  
**Target id (lab):** `opencanary-ntp` · **Evaluation date:** 2026-07-27
...
**Report hub:** [opencanary / ntp](../conformance/reports/opencanary/ntp/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
