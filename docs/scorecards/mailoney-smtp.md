# Scorecard: mailoney — smtp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `smtp`  
**Target id (lab):** `mailoney-smtp` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 38.8 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **38.69** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [mailoney / smtp](../conformance/reports/mailoney/smtp/index.md) · [Tutorial](../conformance/reports/mailoney/TUTORIAL.md) · [Methodology](../conformance/reports/mailoney/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/mailoney/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/mailoney/METHODOLOGY.md).
