# Scorecard: beelzebub — mcp

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Web-API · **Protocol / surface:** `mcp`  
**Target id (lab):** `beelzebub-mcp` · **Evaluation date:** 2026-07-28
...
**Report hub:** [beelzebub / mcp](../conformance/reports/beelzebub/mcp/index.md) · [Tutorial](../conformance/reports/beelzebub/TUTORIAL.md) · [Methodology](../conformance/reports/beelzebub/METHODOLOGY.md)  
