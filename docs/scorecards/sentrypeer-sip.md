...
**Target id (lab):** `sentrypeer-sip` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 43.38 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **43.38** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [sentrypeer / sip](../conformance/reports/sentrypeer/sip/index.md) · [Tutorial](../conformance/reports/sentrypeer/TUTORIAL.md) · [Methodology](../conformance/reports/sentrypeer/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/sentrypeer/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/sentrypeer/METHODOLOGY.md).
