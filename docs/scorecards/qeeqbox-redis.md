# Scorecard: qeeqbox-honeypots — redis

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `redis`  
**Target id (lab):** `qeeqbox-redis` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 34.61 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **34.5** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [qeeqbox-honeypots / redis](../conformance/reports/qeeqbox-honeypots/redis/index.md) · [Tutorial](../conformance/reports/qeeqbox-honeypots/TUTORIAL.md) · [Methodology](../conformance/reports/qeeqbox-honeypots/METHODOLOGY.md)  
