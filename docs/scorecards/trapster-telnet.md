# Scorecard: trapster — telnet

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `telnet`  
**Target id (lab):** `trapster-telnet` · **Evaluation date:** 2026-07-27

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 52.49 | D | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **64.9** | **D** | **0.81** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [trapster / telnet](../conformance/reports/trapster/telnet/index.md) · [Tutorial](../conformance/reports/trapster/TUTORIAL.md) · [Methodology](../conformance/reports/trapster/METHODOLOGY.md)  
