...
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `mysql`  
**Target id (lab):** `mysql-honeypotd` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | 40.35 | F | 0.5625 | See report hub quick artifacts |
| **Full (authoritative)** | **37.94** | **F** | **0.5625** | Verbatim SCORECARD below + `report.json` on the report hub |

**Report hub:** [mysql-honeypotd / mysql](../conformance/reports/mysql-honeypotd/mysql/index.md) · [Tutorial](../conformance/reports/mysql-honeypotd/TUTORIAL.md) · [Methodology](../conformance/reports/mysql-honeypotd/METHODOLOGY.md)  
...
Re-run commands are in the [tutorial](../conformance/reports/mysql-honeypotd/TUTORIAL.md). Environment and limitations are in the [methodology](../conformance/reports/mysql-honeypotd/METHODOLOGY.md).
