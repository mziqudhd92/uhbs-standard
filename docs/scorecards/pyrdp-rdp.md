...
**Target id (lab):** `pyrdp-rdp` · **Evaluation date:** 2026-07-29

| Run | UHQS | Grade | δ_C | Proof artifacts |
| --- | ---: | --- | --- | --- |
| Quick | see report hub quick artifacts | — | — | Report hub |
| **Full (authoritative)** | **33.93** | **F** | **0.5625** | Verbatim SCORECARD below |

**Report hub:** [pyrdp / rdp](../conformance/reports/pyrdp/rdp/index.md)
