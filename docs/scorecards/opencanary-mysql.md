# Scorecard: opencanary — mysql

**Status:** Informative · evaluation proof (not an endorsement)  
**UHBS:** **4.2.2** · **Class:** Low-Interaction · **Protocol / surface:** `mysql`  
**Target id (lab):** `opencanary-mysql` · **Evaluation date:** 2026-07-27
...
**Report hub:** [opencanary / mysql](../conformance/reports/opencanary/mysql/index.md) · [Tutorial](../conformance/reports/opencanary/TUTORIAL.md) · [Methodology](../conformance/reports/opencanary/METHODOLOGY.md)  
