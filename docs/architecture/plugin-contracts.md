...
> [`GOVERNANCE.md`](https://github.com/uhbs/uhbs-standard/blob/main/GOVERNANCE.md). Describes the *current* state of the
...
This is tracked as a follow-up in [`ROADMAP.md`](https://github.com/uhbs/uhbs-standard/blob/main/ROADMAP.md) — **not
