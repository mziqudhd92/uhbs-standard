...
> Spec version: **4.4.4** · Status: **Beta / Experimental** · Last updated: 2026-08-01
>
...
| --- | --- | --- |
| 1 | Normative spec (RFC 2119, document status) | Done for v4.4.4 Beta |
...
| Component | Role |
| --- | --- |
| `run_benchmark.py` | UHBS v4.4.4 orchestrator (phases 1–5) |
...
- [x] Package as installable `uhbs[lab]` / `uhbs-lab`, version == spec `4.4.4`
