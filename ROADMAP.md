...
> Spec version: **4.2.1** · Status: **Beta / Experimental** · Last updated: 2026-07-28
>
...
| --- | --- | --- |
| 1 | Normative spec (RFC 2119, document status) | Done for v4.2.1 Beta |
...
| Component | Role |
| --- | --- |
| `run_benchmark.py` | UHBS v4.2.1 orchestrator (phases 1–5) |
...
- [x] Package as installable `uhbs[lab]` / `uhbs-lab`, version == spec `4.2.1`
